...
try:
    from ._ops import ops  # pyright: ignore[reportMissingImports]
except ImportError as e:
    # Fallback for local development
    try:
        from importlib.util import find_spec

        if find_spec("_gsplat") is None:
            raise ImportError("Failed to find _gsplat module")
...
def render_gsplat(
    ...
    xys, conics = project_gaussians_2d(
